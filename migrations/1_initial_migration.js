const token = artifacts.require('../contracts/TDCToken.sol')
const crowdsale = artifacts.require('../contracts/TDCCrowdsale.sol')
const setDefaultAccount = require('../scripts/setDefaultAccount.js')

module.exports = function(deployer, network, accounts) {
    const rate = new web3.BigNumber(25000)
    const wallet = '0xe257840d5C9b59B01F2cda1509583F1658Bc76ED'
